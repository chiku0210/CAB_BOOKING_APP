...
public class rideconfirm extends javax.swing.JFrame {
    ...
    int j,cost;
    String per;
    String[] butt={"PLEASE WAIT TILL THE RIDE COMPLETES","YOUR RIDE IS COMPLETED CLICK TO EXIT"};
    String butt1="PLEASE WAIT TILL THE RIDE COMPLETES";
    String butt2="YOUR RIDE IS COMPLETED CLICK TO EXIT";   
    public rideconfirm() {
        initComponents();
    }   
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\tulaib pc\\Downloads\\Pics\\images.png")); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 174, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       if(jButton2.getText().equals("Your Ride has been Completed.")){
